...
<div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb danger-color-dark">
                  ...
                  <li class=""><a class="white-text" href="#">Admin</a><i class="fas fa-angle-right mx-2"
                      aria-hidden="true"></i></li>
                  <li class="breadcrumb-item text-light active">Data Kategori</li>
                </ol>
              </nav>
      </div>
    </div>
  <div class="row">
    ...
    <div class="col-md-2  animated fadeInLeft delay-1s">
      <a href="{{route('kategori.create')}}" class="btn btn-success btn-block"><i class="fas fa-plus mr-1"></i> Tambah</a>
      <br>
      <br>
      <a href="{{url('kategoripdf')}}" class="btn btn-primary btn-block"><i class="fas fa-print mr-1"></i> Cetak</a>
      <br>
      <br>
      <a href="{{url('kategoriexcel')}}" class="btn btn-primary  btn-block"><i class="fas fa-file-excel mr-1"></i> Excel</a>
    </div>
            ...
            <table id="datatable" class="table table-hover mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $k->nama }}</td>
                  <td>
                      <a href="{{route('kategori.edit', $k ->id)}}" class="btn btn-yellow btn-sm"><i class="fas fa-edit mr-1"></i> Edit</a>
                      <a href="#" class="btn btn-red btn-sm hapus" link="kategori" hapus-id="{{$k ->id}}"><i class="fas fa-trash mr-1"></i>
                        Delete</a>
                    </form>
                  </td>
                </tr>
